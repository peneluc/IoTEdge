namespace peneluc_iot_edge_central
{
    ...
    class Program
    {
        ...
        static async Task<MessageResponse> FilterMessages(Message message, object userContext)
        {
            ...
            Console.WriteLine($"[Esse método é chamado sempre que o módulo recebe uma mensagem do hub IoT Edge]");
            try
            {
                ...
                {
                    Console.WriteLine($"Temperatura da máquina {messageBody.machine.temperature} excede o limite {_temperaturaLimite}");
